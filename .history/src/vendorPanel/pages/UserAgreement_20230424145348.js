...
const UserAgreement = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const putHandler  = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.put('http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:7777/api/v1/admin/legal/enduser/63c8e366b58e01882b4b0bf7' , {message })
        console.log(data)
      ...
      >
       ...
       <Form onSubmit={putHandler}>
        <Form.Group className="mb-3">
          ...
          <Form.Control type='text' onChange={(e) => setMe} />
        </Form.Group>
       </Form>
        </Modal.Body>
      </Modal>
