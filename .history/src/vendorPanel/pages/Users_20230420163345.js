    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:7777/api/v1/admin/legal/privacy/63c8e2276db88c62208fc7e6`,
          { privacy }
        );
        console.log(data);
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <i className="fa-solid fa-edit" onClick={() => setModal(true)} />
                </td>
              </tr>
            </tbody>
          </Table>
