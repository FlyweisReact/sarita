            ...
            <tbody>
              {data?.data?.map((i, index) => (
                <tr key={index}>
                  ...
                  <td>
                  {i.parcelStatus === "Approved" ? <Badge bg="success"> Approved </Badge> : "" }
                  {i.parcelStatus === "Pending" ? <Badge bg="info"> Pending </Badge> : "" }
                  {i.parcelStatus === "cancel" ? <Badge bg="danger"> Cancelled </Badge> : "" }
                   </td>
                  <td>
                          {i.pickupMan === 'not assigned' ?  <Badge bg="secondary"> Not Assigned </Badge> : i.pickupMan }
                  </td>
                  <td>
