...
const BannedItems = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    function handleAddButtonClick2() {
      setMyArray2(prevArray => [...prevArray, bannedItems]);
      setBannedItem("")
      toast.success("Banned Item Added")
    }
    ...
    const postHandeler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:7777/api/v1/admin/items" ,
          { bannedItems : myArray, restrictedItems } , {
            headers : {
                Authorization : `Bearer ${token}`
            }
          }
      ...
      >
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3" style={{width : '80%'}}>
            ...
            <i className="fa-sharp fa-solid fa-plus" style={{fontSize : '2rem' , paddingTop  : '10px'}}  onClick={handleAddButtonClick} ></i>
          </div>
