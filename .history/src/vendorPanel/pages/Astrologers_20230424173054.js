...
const Astrologers = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const fetchMan = async () => {
      try {
        const { data } = await axios.get("http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:7777/api/v1/pickupMan")
        setEach(data)
      }catch(e) { 
        console.log(e)
      }
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
        { edit  ? <Form onSubmit={edit ? putHandler : ""}>
...
</Form> : <Form onSubmit={edit ? putHandler : ""}>
