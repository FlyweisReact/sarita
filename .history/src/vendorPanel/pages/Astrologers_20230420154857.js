...
const Astrologers = () => {
  ...
  function MyVerticallyCenteredModal(props) {
      ...
      const putHandler = async (e) => {
        e.preventDefault()
        try {
          const { data  } = await axios.put(`http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:7777/api/v1/admin/shippings/${id}` , { parcelStatus})
          console.log(data)
          fetchData()
      ...
      >
        ...
        <Modal.Body>
          <Form onSubmit={edit ? putHandler : ""} >
            <Form.Select className="mb-3" onChange={(e) => setParcelStatus(e.target.value)} >
              <option>-- Select Status --</option>
              <option value='Approved'>Approved</option>
              <option value='Pending'>Pending</option>
              <option value='cancel'>Approved</option>
            </Form.Select>
