          ...
          <Table striped bordered hover>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <Button style={{ backgroundColor: "#19376d", borderRadius: "0" }} onClick={() => setModalShow(true)} > Assign</Button>
                </td>
                <td>
            ...
            <tr key={index}>
              ...
              <td>
              <span>
              {i.shippingFrom?.city + "" + i.shippingFrom?.city + "" + i.shippingFrom?.city +" " i.shippingFrom?.city}
               </span>
               </td>
              <td>
              <ul>
