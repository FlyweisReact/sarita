        ...
        <Modal.Body>
          <Container>
            ...
            {each?.data?.packages?.map((i, index) => (
              ...
              <p className="View">
                  {" "}
                  <strong>Package Length : </strong> {i.unitLength}{" "}
                </p>
                <p className="View">
                  {" "}
                  <strong>Package unitWidth : </strong> {i.unitWidth}{" "}
                </p>
                <p className="View">
                  {" "}
                  <strong>Package unitHeight : </strong> {i.unitHeight}{" "}
                </p>
                <p className="View">
                  {" "}
                  <strong>Package unitWeight : </strong> {i.unitWeight}{" "}
                </p>
                <p className="View">
                  {" "}
                  <strong>Package packageCategory : </strong> {i.packageCategory}{" "}
                </p>
                <p className="View">
                  {" "}
                  <strong>Package unitHeight : </strong> {i.unitHeight}{" "}
                ...
                <p className="View">
                  {" "}
                  <strong>Package Length : </strong> {i.packageCategory}{" "}
                </p>
              </div>
