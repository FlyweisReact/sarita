    ...
    <>
      ...
      >
        ...
        <nav className="py-6">
          ...
          <Dropdown>
            <Dropdown.Toggle id="dropdown-basic" style={{backgroundColor : 'transparent' , border : 'none' , display : 'flex' , alignItems : 'center'}}>
            <BiLogOutCircle className="text-xl mr-3 rounded-full " />  Legal Docs
            </Dropdown.Toggle>
